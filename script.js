...
function displayItems() {
  const itemsFromStorage = Storage.getItemsFromStorage();
...
function onAddItemSubmit(e) {
  ...
  if (isEditMode) {
    ...
    Storage.removeItemFromStorage(itemToEdit.textContent);
...
function removeItem(item) {
  if (
    ...
    Storage.removeItemFromStorage(item.textContent);
...
function clearItems() {
  ...
  Storage.removeAllItemsFromStorage();
